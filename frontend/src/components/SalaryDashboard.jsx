...
export default function SalaryDashboard({ employeeId, employee, employeeRoute = false, refreshKey = 0 }) {
  ...
  const labels = [['Present', 'Days Present'], ['Absent', 'Days Absent'], ['Halfday', 'Half Days'], ['WFH', 'WFH'], ['On Site Work', 'On Site Work'], ['Paid Holidays', 'Paid Holidays'], ['Festival', 'Festival'], ['Paid Leave', 'Paid Leave'], ['Paid Sundays', 'Paid Sundays']];
